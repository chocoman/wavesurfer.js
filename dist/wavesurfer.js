/*!
 * wavesurfer.js 2.2.0 (2019-03-12)
  ...
  _createClass(MultiCanvas, [{
    ...
    value: function drawBars(peaks, channelIndex, start, end) {
      ...
      return this.prepareDraw(peaks, channelIndex, start, end, function (_ref) {
        var absmax = _ref.absmax,
            ...
            halfH = _ref.halfH,
            peaks = _ref.peaks,
            channelIndex = _ref.channelIndex;
        ...
        for (i = first; i < last; i += step) {
          ...
          _this4.fillRect(i + _this4.halfPixel, halfH - h + offsetY, bar + _this4.halfPixel, h * 2, channelIndex);
        }
      });
    }
    /**
    ...
    value: function drawWave(peaks, channelIndex, start, end) {
      ...
      return this.prepareDraw(peaks, channelIndex, start, end, function (_ref2) {
        ...
        _this5.fillRect(0, halfH + offsetY - _this5.halfPixel, _this5.width, _this5.halfPixel, channelIndex);
      });
    }
    /**
    ...
    value: function drawLine(peaks, absmax, halfH, offsetY, start, end, channelIndex) {
      ...
      this.canvases.forEach(function (entry) {
        _this6.setFillStyles(entry, channelIndex);
    ...
    key: "fillRect",
    value: function fillRect(x, y, width, height, channelIndex) {
      ...
      return util.frame(function () {
        ...
        if (peaks[0] instanceof Array) {
          ...
          if (_this7.params.splitChannels) {
            if (_this7.params.splitChannelsOverlay) {
              _this7.setHeight(_this7.params.height * _this7.params.pixelRatio);
            } else {
    ...
    key: "setFillStyles",
    value: function setFillStyles(entry, channelIndex) {
      var waveColor = this.params.waveColor;
      var progressColor = this.params.progressColor;

      if (this.params.waveColor instanceof Array) {
        waveColor = this.params.waveColor[channelIndex];
      }

      if (this.params.progressColor instanceof Array) {
        progressColor = this.params.progressColor[channelIndex];
      }

      entry.waveCtx.fillStyle = waveColor;

      if (this.hasProgressCanvas) {
        entry.progressCtx.fillStyle = progressColor;
      }
    }
    /**
